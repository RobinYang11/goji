    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <thead class="eb-table-head-bg">
        ...
        <th v-for="cItem in newCol" :width="cItem.width" :align="cItem.align ? cItem.align : 'center'" class="eb-table-thr-border">
          {{ cItem.label }}
          <!--    过滤-筛选     -->
          <el-icon v-if="cItem.filter" class="eb-table-th-icon" @click="cItem.showFilter = !cItem.showFilter"><Search /></el-icon>
...
.eb-table-th-filterbox-input { display: inline-block; width: 132px; height: 28px; margin-bottom: 8px }
.eb-table-th-filterbox-button { display: inline-block; width: 140px; height: 28px; }
</style>
